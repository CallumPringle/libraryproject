...
public class Main {
    ...
    public static void fileNamesStore(String bussycum){
        try {
                FileWriter myWriter = new FileWriter("filenames.txt", false);
                myWriter.write(bussycum);
                myWriter.close();
    ...
    public static void createNewFile(String ballsex) {
        try {
            File myObj = new File(ballsex + ".txt");
            if (myObj.createNewFile()) {
                FileWriter myWriter = new FileWriter(ballsex + ".txt", false);
    ...
    public static void createFile(String ballsex) {
        try {
            File myObj = new File(ballsex);
            if (myObj.createNewFile()) {
                FileWriter myWriter = new FileWriter(ballsex, false);
                myWriter.write("Title, ISBN, Author, Genre:\n");
                myWriter.close();
                System.out.println("File created " + myObj.getName());
            }
